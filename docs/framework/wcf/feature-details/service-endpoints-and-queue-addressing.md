...
|`Net.msmq://<machine-name>/private/abc`|×|SRMP|`DIRECT=http://machine/msmq/private$/abc`|  
|`Net.msmq://<machine-name>/private/abc`|○|ネイティブ|`PUBLIC=some-guid` (キューの GUID)|  
