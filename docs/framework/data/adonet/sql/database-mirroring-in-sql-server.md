...
## <a name="database-mirroring-resources"></a><span data-ttu-id="127cc-136">データベース ミラーリングに関するリソース</span><span class="sxs-lookup"><span data-stu-id="127cc-136">Database Mirroring Resources</span></span>  
