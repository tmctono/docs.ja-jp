...
```  
 ...
 <span data-ttu-id="dfa01-163">この例は、`books.xml` ファイルを入力として使用します。</span><span class="sxs-lookup"><span data-stu-id="dfa01-163">The example takes the `books.xml` file as input.</span></span>  
