...
---
### <a name="iasyncresultcompletedsynchronously-property-must-be-correct-for-the-resulting-task-to-complete"></a><span data-ttu-id="e9181-101">IAsyncResult.CompletedSynchronously プロパティが正しくなければ、結果のタスクは完了しません</span><span class="sxs-lookup"><span data-stu-id="e9181-101">IAsyncResult.CompletedSynchronously property must be correct for the resulting task to complete</span></span>

#### <a name="details"></a><span data-ttu-id="e9181-102">説明</span><span class="sxs-lookup"><span data-stu-id="e9181-102">Details</span></span>

<span data-ttu-id="e9181-103">TaskFactory.FromAsync を呼び出すとき、<xref:System.IAsyncResult.CompletedSynchronously> プロパティの実装が正しくなければ、結果のタスクは完了しません。</span><span class="sxs-lookup"><span data-stu-id="e9181-103">When calling TaskFactory.FromAsync, the implementation of the <xref:System.IAsyncResult.CompletedSynchronously> property must be correct for the resulting task to complete.</span></span> <span data-ttu-id="e9181-104">つまり、実装が同期的に完了した場合にのみ、このプロパティは true を返す必要があります。</span><span class="sxs-lookup"><span data-stu-id="e9181-104">That is, the property must return true if, and only if, the implementation completed synchronously.</span></span> <span data-ttu-id="e9181-105">以前は、このプロパティは確認されていませんでした。</span><span class="sxs-lookup"><span data-stu-id="e9181-105">Previously, the property was not checked.</span></span>

#### <a name="suggestion"></a><span data-ttu-id="e9181-106">提案される解決策</span><span class="sxs-lookup"><span data-stu-id="e9181-106">Suggestion</span></span>

<span data-ttu-id="e9181-107">タスクが同期的に完了したときにのみ、<xref:System.IAsyncResult?displayProperty=fullName> の実装が <xref:System.IAsyncResult.CompletedSynchronously?displayProperty=fullName> プロパティに true を返す場合、中断は発生しません。</span><span class="sxs-lookup"><span data-stu-id="e9181-107">If <xref:System.IAsyncResult?displayProperty=fullName> implementations correctly return true for the <xref:System.IAsyncResult.CompletedSynchronously?displayProperty=fullName> property only when a task completed synchronously, then no break will be observed.</span></span> <span data-ttu-id="e9181-108">ユーザーは、所有する <xref:System.IAsyncResult?displayProperty=fullName> の実装 (ある場合) を見直して、タスクが同期的に完了したかどうかを正しく評価することを確認する必要があります。</span><span class="sxs-lookup"><span data-stu-id="e9181-108">Users should review <xref:System.IAsyncResult?displayProperty=fullName> implementations they own (if any) to ensure that they correctly evaluate whether a task completed synchronously or not.</span></span>

| <span data-ttu-id="e9181-109">名前</span><span class="sxs-lookup"><span data-stu-id="e9181-109">Name</span></span>    | <span data-ttu-id="e9181-110">[値]</span><span class="sxs-lookup"><span data-stu-id="e9181-110">Value</span></span>       |
|:--------|:------------|
| <span data-ttu-id="e9181-111">スコープ</span><span class="sxs-lookup"><span data-stu-id="e9181-111">Scope</span></span>   | <span data-ttu-id="e9181-112">エッジ</span><span class="sxs-lookup"><span data-stu-id="e9181-112">Edge</span></span>        |
| <span data-ttu-id="e9181-113">バージョン</span><span class="sxs-lookup"><span data-stu-id="e9181-113">Version</span></span> | <span data-ttu-id="e9181-114">4.5</span><span class="sxs-lookup"><span data-stu-id="e9181-114">4.5</span></span>         |
| <span data-ttu-id="e9181-115">種類</span><span class="sxs-lookup"><span data-stu-id="e9181-115">Type</span></span>    | <span data-ttu-id="e9181-116">再ターゲット中</span><span class="sxs-lookup"><span data-stu-id="e9181-116">Retargeting</span></span> |

#### <a name="affected-apis"></a><span data-ttu-id="e9181-117">影響を受ける API</span><span class="sxs-lookup"><span data-stu-id="e9181-117">Affected APIs</span></span>
